...
import { TakeInventory, clickedInvItem, Send } from './modules/inventory.js';
...
export function GiveEscapeButton(x, y, z, platform='basic') {
    return new Promise((resolve, reject) => {
        if (clickedInvItem != null && clickedInvItem.className != undefined) {
            ...
            PlaySound('./static/sounds/laser_send.mp3')
