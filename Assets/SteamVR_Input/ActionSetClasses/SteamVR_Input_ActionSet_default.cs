...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean TouchpadLaserTrigger
        {
            get
            {
                return SteamVR_Actions.default_TouchpadLaserTrigger;
            }
        }
        
        public virtual SteamVR_Action_Boolean TouchPadLasterButtonA
        {
            get
            {
                return SteamVR_Actions.default_TouchPadLasterButtonA;
            }
        }
